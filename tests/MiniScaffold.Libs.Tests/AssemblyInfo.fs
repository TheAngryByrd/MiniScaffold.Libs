...
[<assembly: AssemblyTitleAttribute("MiniScaffold.Libs.Tests")>]
[<assembly: AssemblyProductAttribute("MiniScaffold.Libs")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "MiniScaffold.Libs.Tests"
    let [<Literal>] AssemblyProduct = "MiniScaffold.Libs"
